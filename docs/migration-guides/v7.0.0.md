...
If you have previously added an [`.eslintrc`](https://eslint.org/docs/user-guide/configuring) file to your project, it is now generated and managed by sku. It&rsquo;s also added to your `.gitignore` automatically. This ensures it&rsquo;s always consistent with the `sku lint` command, while supporting editor integrations to give you live ESLint feedback during development.
