...
const runPrettier = async ({ write, listDifferent, pathsToCheck = [] }) => {
  console.log(
...
module.exports = {
  check: pathsToCheck => runPrettier({ listDifferent: true, pathsToCheck }),
  write: pathsToCheck => runPrettier({ write: true, pathsToCheck })
};
