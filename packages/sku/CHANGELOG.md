...
- Add pathAliases configuration for custom import paths with Vite bundler. ([#1339](https://github.com/seek-oss/sku/pull/1339))
...
- `vite`: Add support for `displayNameProd` sku.config option ([#1327](https://github.com/seek-oss/sku/pull/1327))

- `build(vite)`: Generate bundle analysis reports ([#1344](https://github.com/seek-oss/sku/pull/1344))
...
- `vite`: Add support for `polyfills` config ([#1321](https://github.com/seek-oss/sku/pull/1321))
...
- `init`: Populate `packageManager` field in `package.json` if the new app is at the repo root ([#1322](https://github.com/seek-oss/sku/pull/1322))
...
- `start`: Align webpack and vite `start` implementations ([#1324](https://github.com/seek-oss/sku/pull/1324))

- `init`: dependencies will now correctly be pinned in workspaces ([#1341](https://github.com/seek-oss/sku/pull/1341))
...
- `types`: Sku config has better type safety for webpack and (experimental) vite options ([#1343](https://github.com/seek-oss/sku/pull/1343))

- Replace `didyoumean2` dependency with `fastest-levenshtein` ([#1345](https://github.com/seek-oss/sku/pull/1345))

- Don't emit `sku start` telemetry when `OPEN_TAB=false` is set ([#1335](https://github.com/seek-oss/sku/pull/1335))

- `sku init`: Specify an exact version of `sku` when installing dependencies ([#1302](https://github.com/seek-oss/sku/pull/1302))
...
- `vite start`: Inline Vanilla Extract CSS to fix flash of unstyled text ([#1332](https://github.com/seek-oss/sku/pull/1332))

- Updated dependencies [[`3f6fe0c`](https://github.com/seek-oss/sku/commit/3f6fe0ccac359ccd6127ce77895a867e66099af3)]:
  - @sku-lib/vite@0.1.2
