  ...
  test('components', () => {
    expect(
      ...
      "<style type="text/css">
                ...
                </style><div class="seekJobs_seekJobs__1sh8lan0 typography_lightModeTone_light__ndjjoi10 typography_darkModeTone_dark__ndjjoi13"><div class="reset_base__14h31gj0 sprinkles_paddingTop_large_mobile__7n536n85 App_vanillaBox__inn18b0"></div></div>"
    `);
  });
});
