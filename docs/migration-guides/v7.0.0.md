...
Build output folder structure has changed in some circumstances. After making the following changes please your `target` directory and update your testing and deployment strategies to suit.

### render

If your app renders multiple pages/routes then first open up your `sku.config.js`.
Using the new `routes` option, detail all your applications routes. See [static-rendering](../static-rendering) for more info.
