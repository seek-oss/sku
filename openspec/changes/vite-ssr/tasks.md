...
- [x] 2.2 Re-export shared runtime symbols from `sku/runtime` so Vite keeps one module identity (`SkuProvider`, insert-html helpers, site route registration, request-context runner).
