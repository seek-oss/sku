...
- Update `@ast-grep/napi` dependency to `^0.42.0` ([#1534](https://github.com/seek-oss/sku/pull/1534))

## 1.2.5

### Patch Changes

- Update `@ast-grep/napi` dependency to `^0.41.0` ([#1509](https://github.com/seek-oss/sku/pull/1509))
